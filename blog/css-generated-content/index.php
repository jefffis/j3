<?php include("../../includes/header.php"); ?>
	<title  dir=ltr>CSS Generated Content by Jefff</title>
<?php include("../../includes/content.php"); ?>
		<article class="full">	
			<h2 class="header">july 20, 2012 <span>css</span></h2>
			<h1>CSS Generated Content: What Is It &amp; What&rsquo;s Possible?</h1>
			<p><strong><img src="http://jhische.com/dailydropcap/W-1-cap.png" title="Daily Drop Cap by Jessica Hische" alt="W" id="drop-cap" /><del>W</del>e&rsquo;re going to look at when to use CSS generated content and when not to.</strong> CSS generated content? Yep, you read that right. It&rsquo;s a real thing. A pretty awesome thing too, honestly. What it enables web designers and developers to do is pretty swanky and [can be] pretty helpful to boot.</p>
			<p>So what do I mean when I say <a href="http://www.w3.org/TR/CSS21/generate.html" target="_blank">CSS generated content</a>? Well, it&rsquo;s somewhat complicated, so lemme try to break it down. CSS generated content is a technique that allows content (HTML and/or images) to be <a href="http://en.wikipedia.org/wiki/Document_Object_Model" target="_blank">inserted into the DOM</a> without actually being included in the HTML. <strong>Say what?</strong> A bit odd, but basically if you view the source of a page using this, you won&rsquo;t find the corresponding code in the HTML. It&rsquo;s being added in via CSS, and therefore is usually considered just for presentational purposes.</p>
			<p>For this, you, or whomever, will be <a href="http://reference.sitepoint.com/css/pseudoelements" target="_blank">using pseudo elements</a> of <code>:before</code> and <code>:after</code>, relating to a particular elements normal styling. For example (just a stupidly simple example):</p>
<pre>
&lt;style type="text/css"&gt;
  * {
    padding:0;
...
<ul>
	<li><a href="/misc/css-only-image-drop-shadow/" target="_blank">CSS-only Drop Shadows (by me, but tweaked of another)</a></li>
	<li><a href="http://viget.com/inspire/css-generated-content" target="_blank">My New Best Friend: CSS Generated Content</a></li>
	<li><a href="http://css-tricks.com/pseudo-element-roundup/" target="_blank">A Whole Bunch of Amazing Stuff Pseudo Elements Can Do</a></li>
	<li><a href="http://caniuse.com/css-gencontent" target="_blank">When can I use CSS Generated content?</a></li>
	<li><strong>Screen Reader Edit:</strong> <a href="http://www.456bereastreet.com/archive/201205/css_generated_content_and_screen_readers/" target="_blank">CSS generated content and screen readers</a></li>
</ul>
